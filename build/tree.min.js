...
Node.prototype.removeParent=function(a){this.parent=null;this.depth=0;this.removeAncestors([a]);this.removeAncestors(a.ancestors)};Node.prototype.addAncestors=function(a){Array.prototype.push.apply(this.ancestors,a);if(!this.isLeaf())for(i=0;i<this.children.length;++i)this.children[i].addAncestors(a)};Node.prototype.removeAncestors=function(a){for(i=0;i<a.length;++i)this.ancestors.splice(this.ancestors.indexOf(a[i]),1);if(!this.isLeaf())for(i=0;i<this.children.length;++i)this.children[i].removeAncestors(a)};
Node.prototype.addDecendants=function(a){Array.prototype.push.apply(this.decendants,a);this.isRoot()||this.parent.addDecendants(a)};Node.prototype.removeDecendants=function(a){for(i=0;i<a.length;++i)this.decendants.splice(this.decendants.indexOf(a[i]),1);this.isRoot()||parent.removeDecendants(a)};Node.prototype.isLeaf=function(){return!this.children.length};Node.prototype.isRoot=function(){return!this.depth};
Node.prototype.getDecendantsByName=function(a){return this.decendants.filter(function(b){return b.name===a})};Node.prototype.getDecendantByName=function(a){return this.getDecendantsByName(a)[0]};Node.prototype.getChildrenByName=function(a){return children.filter(function(b){return b.name===a})};Node.prototype.getChildByName=function(a){return this.getChildrenByName(a)[0]};var Tree=function(a){this.name=a;this.root=new Node("root");this.root.parent=null;this.root.depth=0};
