var Node=function(a){this.name=a;this.parent=this.depth=null;this.children=[];this.ancestors=[];this.decendants=[]};Node.prototype.addChild=function(a){a?(this.children.push(a),this.addDecendants([a]),this.addDecendants(a.decendants),a.setParent(this)):console.warn("The child to add is "+a)};
Node.prototype.removeChild=function(a){a?-1==this.children.indexOf(a)?console.warn("The specified child is not a child of the parent; cannot remove child"):(this.children.splice(this.children.indexOf(a),1),this.removeDecendants([a]),this.removeDecendants(a.decendants),a.removeParent(this)):console.warn("The child to remove is "+a)};Node.prototype.breakBranch=function(){this.parent.removeChild(this)};Node.prototype.setParent=function(a){this.parent=a;this.depth=a.depth+1;this.addAncestors([a]);this.addAncestors(a.ancestors)};
