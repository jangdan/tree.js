...
Node.prototype.removeAncestors = function(ancestors){
	...
	for( var i = 0; i < ancestors.length; ++i ) this.ancestors.splice( this.ancestors.indexOf(ancestors[i]), 1 );
	...
	for( var i = 0; i < this.children.length; ++i ) this.children[i].removeAncestors(ancestors);
...
Node.prototype.removeDecendants = function(decendants){
	...
	for( var i = 0; i < decendants.length; ++i ) this.decendants.splice( this.decendants.indexOf(decendants[i]), 1 );
